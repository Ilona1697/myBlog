...
<main class="blog">
        <div class="container">
            ...
            <section class="featured-posts-section">
                ...
                <div class="mx-auto row d-flex justify-content-center" style="margin-top:-100px;">
                    {{$posts->links()}}
                </div>
            </section>
            <div class="row">
                    ...
                    <section>
                        ...
                        @foreach($randomPosts as $randomPost)
                            <div class="col-md-6 blog-post" data-aos="fade-up">
                                <div class="blog-post-thumbnail-wrapper">
                                    <img src="{{ asset('storage/app/public/' . $randomPost->preview_image) }}" alt="blog post">
                                </div>
                                <div class="d-flex justify-content-between align-items-center">
                        ...
                        <ul class="post-list">
                            ...
                            <li class="post">
                                <a href="{{ route('post.show', $post->id)}}" class="post-permalink media">
                                    <img src="{{ asset('storage/app/public/' . $likedPost->preview_image) }}" alt="blog post">
